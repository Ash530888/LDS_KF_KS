...
def main(argv):
    ...
    # filterLDS(y, B, Q, m0, V0, Z, R)
    filterRes = inference.filterLDS(y, B, Q, m0, V0, Z, R)

    # smoothLDS(B, xnn, Vnn, xnn1, Vnn1, m0, V0)
    smoothRes = inference.smoothLDS(B, xnn=filterRes["xnn"], Vnn=filterRes["Vnn"], xnn1=filterRes["xnn1"], Vnn1=filterRes["Vnn1"], m0=m0, V0=V0)
